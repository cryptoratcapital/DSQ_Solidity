...
const HESSIANX_NONREVOKE_BENEFICIARIES = require("../../resources/vesting_22_03_2023/unlockLinear/nonrevocableBeneficiaries-2022-03-22.json");
...
async function main() {
  ...
  for (const beneficiary of BENEFICIARIES) {
    ...
    const vesting = await Vesting.deploy(beneficiary["address"], OTC_UNLOCK, START_TIME, VESTING_DURATION, DSQ_MULTISIG);
    ...
    await hre.run("verify:verify", {
      ...
      constructorArguments: [beneficiary["address"], OTC_UNLOCK, START_TIME, VESTING_DURATION, DSQ_MULTISIG],
    });
  ...
  const FILENAME = "2023-03-22-TeamVestingDeployments.json";
  try {
