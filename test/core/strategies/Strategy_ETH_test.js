...
async function deployStrategy() {
  ...
  Strategy = await ethers.getContractFactory("Strategy_ETH");
  strategy = await Strategy.deploy(devWallet.address, traderFacet.address, traderInitializerParams, facets, assets, oracles);

  strategyDiamond = await ethers.getContractAt("StrategyDiamond_ETH", strategy.address);
